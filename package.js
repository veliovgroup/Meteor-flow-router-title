...
Package.onUse(function (api) {
  ...
  api.use(['underscore', 'ecmascript', 'reactive-var', 'tracker', 'ostrio:flow-router-extra@3.4.3'], 'client');
  api.mainModule('flow-router-title.js', 'client');
});

Package.onTest(function(api) {
  api.use(['tinytest', 'ecmascript', 'random', 'session', 'reactive-var', 'tracker', 'ostrio:flow-router-extra@3.4.3', 'ostrio:flow-router-title'], 'client');
